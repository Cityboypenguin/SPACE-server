...
type ListMyDMRoomsUseCase interface {
	Execute(ctx context.Context, userID int64, q repository.PageQuery) ([]*model.Room, int, error)
}
...
func (uc *ListMyDMRoomsInteractor) Execute(ctx context.Context, userID int64, q repository.PageQuery) ([]*model.Room, int, error) {

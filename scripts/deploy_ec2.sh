...
ACTIVITY_ARCHIVE_HMAC_KEY="$(get_param /space/activity-archive-hmac-key)"
...
ACTIVITY_ARCHIVE_HMAC_KEY=${ACTIVITY_ARCHIVE_HMAC_KEY}
...
MINIO_PRIVATE_BUCKET=space-activity-archives
AWS_REGION=${REGION}

...
type ComplexityRoot struct {
	...
	Query struct {
		...
		GetFavoritesByPostID            func(childComplexity int, postID string) int
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.getFavoritesByPostID":
		if e.ComplexityRoot.Query.GetFavoritesByPostID == nil {
			break
		}

		args, err := ec.field_Query_getFavoritesByPostID_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.ComplexityRoot.Query.GetFavoritesByPostID(childComplexity, args["post_id"].(string)), true
...
func (ec *executionContext) field_Query_getFavoritesByPostID_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
...
func (ec *executionContext) _Query_getFavoritesByPostID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Query_getFavoritesByPostID(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Query().GetFavoritesByPostID(ctx, fc.Args["post_id"].(string))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*model.Favorite) graphql.Marshaler {
			return ec.marshalNFavorite2ᚕᚖgithubᚗcomᚋCityboypenguinᚋSPACEᚑserverᚋgraphᚋmodelᚐFavoriteᚄ(ctx, selections, v)
...
func (ec *executionContext) fieldContext_Query_getFavoritesByPostID(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_getFavoritesByPostID_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
	...
	for i, field := range fields {
		...
		case "getFavoritesByPostID":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_getFavoritesByPostID(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
